...
<div class="mx-auto max-w-6xl w-full">
  ...
  <a href="/admin/equipements/create" class="bg-blue-500 text-white px-4 py-2 rounded">Créer un équipement</a>
      ...
      <?php foreach ($equipements as $equipement) : ?>
        <tr>
          ...
          <td class="border-l px-4 py-2 flex items-center gap-2">
            <a href="/admin/equipements/<?= $equipement->{'id'} ?>" class="text-blue-500">Voir</a>
