...
export class UpdateNames1678701451660 implements MigrationInterface {
  name = 'UpdateNames1678701451660'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`reservation\` CHANGE \`addresse\` \`adresse\` varchar(255) NOT NULL`
    )
    await queryRunner.query(
      `ALTER TABLE \`bateau\` CHANGE \`poidsMax\` \`poids_max\` float(12) NULL`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`reservation\` DROP COLUMN \`adresse\``
    )
    await queryRunner.query(
      `ALTER TABLE \`reservation\` ADD \`adresse\` varchar(255) NOT NULL`
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`bateau\` CHANGE \`poids_max\` \`poidsMax\` float(12) NULL`
    )
    await queryRunner.query(
      `ALTER TABLE \`reservation\` CHANGE \`adresse\` \`addresse\` varchar(255) NOT NULL`
    )
    await queryRunner.query(
      `CREATE INDEX \`IDX_349f1f97df962f636dbfc35e5e\` ON \`reservations_types\` (\`type_id\`)`
    )
