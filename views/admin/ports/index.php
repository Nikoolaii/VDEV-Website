...
<div class="mx-auto max-w-6xl w-full">
  <h1 class="text-3xl mb-4">Les ports</h1>

  <a href="/admin/ports/create" class="bg-blue-500 text-white px-4 py-2 rounded">Créer un port</a>
  ...
  <table class="w-full text-left mt-4">
    ...
    <tbody>
      <?php foreach ($ports as $port) : ?>
        <tr>
          <td><?= $port->{'id'} ?></td>
          <td class="border-l px-4 py-2"><?= $port->{'nom'} ?></td>

          <td class="border-l px-4 py-2 flex items-center gap-2">
            <a href="/admin/ports/<?= $port->{'id'} ?>" class="text-blue-500">Voir</a>
