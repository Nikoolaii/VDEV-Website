...
export class ChangeLiaisonDistanceType1677782271153
  implements MigrationInterface
{
  name = 'ChangeLiaisonDistanceType1677782271153'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`liaison\` DROP COLUMN \`distance\``)
    await queryRunner.query(
      `ALTER TABLE \`liaison\` ADD \`distance\` float NOT NULL`
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`liaison\` DROP COLUMN \`distance\``)
    await queryRunner.query(
      `ALTER TABLE \`liaison\` ADD \`distance\` int NOT NULL`
    )
    await queryRunner.query(
      `ALTER TABLE \`bateaux_categories\` DROP COLUMN \`capacite_max\``
    )
