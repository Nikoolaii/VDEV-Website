...
export class ChangeTarifType1677783045990 implements MigrationInterface {
  name = 'ChangeTarifType1677783045990'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`liaisons_types_periodes\` DROP COLUMN \`tarif\``
    )
    await queryRunner.query(
      `ALTER TABLE \`liaisons_types_periodes\` ADD \`tarif\` float NOT NULL`
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`liaisons_types_periodes\` ADD \`tarif\` int NOT NULL`
    )
    await queryRunner.query(
      `ALTER TABLE \`reservations_types\` DROP COLUMN \`quantite\``
    )
